...
### Queue Mode Load (`kafka-load-queue.spec.ts`)
...
# Overnight benchmark suite (all profiles × worker variants)
bash packages/testing/playwright/tests/infrastructure/kafka-load/run-overnight-benchmarks.sh
```
